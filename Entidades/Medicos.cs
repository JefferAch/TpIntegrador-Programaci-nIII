...
namespace Entidades
{
    ...
    public class Medico
    {
        ...
        public Medico(int legajoMed, string nombreMed, string apellMed, string correo, string TelefonoMed, TimeSpan horaInicio, TimeSpan horaFinal, int DniMed, char sexo, string nacionalidadMed, DateTime nacimiento, string direccion)
        {
